...
glfw.swap_interval(1)   # 启用垂直同步（VSync），限制帧率与显示器刷新率同步，设为0则为无限帧率，GPU占用高
...
# 接触力显示化
opt.flags[mj.mjtVisFlag.mjVIS_CONTACTPOINT] = False   # 碰撞接触点显示选项
opt.flags[mj.mjtVisFlag.mjVIS_CONTACTFORCE] = False   # 碰撞接触力显示选项
